...
start_btn = Button(
    text="Start", bg=GREEN, border=0, highlightthickness=0, command=start_timer
)
start_btn.grid(column=0, row=2)

reset_btn = Button(
    text="Reset", bg=GREEN, border=0, highlightthickness=0, command=reset_timer
)
reset_btn.grid(column=2, row=2)

# check_marks = "✅"
check_marks = "✔️"
check_marks_label = Label(font=(FONT_NAME, 40), fg=GREEN, bg=YELLOW)
